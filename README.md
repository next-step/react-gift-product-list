...
- [ ] `/api/themes/:themeId/info` API 를 사용하여 선물 테마 섹션의 히어로 영역을 구현
- [ ] 테마 정보를 가져오는 API 에서 404 에러 발생 시, `/home` 으로 이동
- [ ] `/api/themes/:themeId/products` API 를 사용하여 상품 리스트를 구현
- [ ] 무한 스크롤 구현
- [ ] 상품 리스트가 없으면 빈 페이지 보여주기
