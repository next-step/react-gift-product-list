...
- [] 선물 테마 섹션의 아이템 클릭 시 테마 상품 목록 페이지로 연결
- [] /api/themes/:themeId/info API 사용하여 선물 테마 섹션의 히어로 영역 구현
- [] 테마 정보 가져오는 API 404 에러 발생 시 홈 페이지로 연결
- [] /api/themes/:themeId/products API 사용하여 상품 리스트 구현
- [] 무한 스크롤 기능 구현
- [] 상품 리스트가 없으면 빈 페이지 구현
